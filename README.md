...
| You want to… | Go to |
|---|---|
| Learn the concepts, in Spanish, with diagrams | [`manual.html`](manual.html) — 12 chapters, 24 hand-drawn figures |
...
sentence, one sum you can do by hand, one five-step recipe, and one sentence
carried through every step of it - before chapter 10 starts measuring it.
