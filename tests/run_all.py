...
SUITES = (
    ...
    ("tf_core", "test_transformer_core.py", False, "token tasks, positions and the four map verdicts"),
    ...
    ("tf_gui", "test_transformer_gui.py", True, "the whole transformer workspace"),
)
